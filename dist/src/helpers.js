...
const TransparentUpgradeableProxy_json_2 = __importDefault(require("../extendedArtifacts/zk/TransparentUpgradeableProxy.json"));
const OptimizedTransparentUpgradeableProxy_json_2 = __importDefault(require("../extendedArtifacts/zk/OptimizedTransparentUpgradeableProxy.json"));
const ProxyAdmin_json_2 = __importDefault(require("../extendedArtifacts/zk/ProxyAdmin.json"));
const EIP173Proxy_json_2 = __importDefault(require("../extendedArtifacts/zk/EIP173Proxy.json"));
const EIP173ProxyWithReceive_json_2 = __importDefault(require("../extendedArtifacts/zk/EIP173ProxyWithReceive.json"));
const ERC1967Proxy_json_2 = __importDefault(require("../extendedArtifacts/zk/ERC1967Proxy.json"));
const Diamond_json_2 = __importDefault(require("../extendedArtifacts/zk/Diamond.json"));
const DiamondERC165Init_json_2 = __importDefault(require("../extendedArtifacts/zk/DiamondERC165Init.json"));
const DiamondCutFacet_json_2 = __importDefault(require("../extendedArtifacts/zk/DiamondCutFacet.json"));
const DiamondLoupeFacet_json_2 = __importDefault(require("../extendedArtifacts/zk/DiamondLoupeFacet.json"));
const OwnershipFacet_json_2 = __importDefault(require("../extendedArtifacts/zk/OwnershipFacet.json"));
...
getArtifact, saveDeployment, willSaveToDisk, onPendingTx, getGasPrice, log, print) {
    ...
    async function _getProxyInfo(name, options) {
        ...
        let updateArgs;
        let upgradeIndex;
        let proxyContract = network.zksync ? EIP173Proxy_json_2.default : EIP173Proxy_json_1.default;
                ...
                if (typeof options.proxy.proxyContract === 'string') {
                    ...
                    if (!proxyContract || proxyContract === EIP173Proxy_json_1.default) {
                        if (options.proxy.proxyContract === 'EIP173ProxyWithReceive') {
                            ...
                            proxyContract = network.zksync ? TransparentUpgradeableProxy_json_2.default : TransparentUpgradeableProxy_json_1.default;
                            viaAdminContract = 'DefaultProxyAdmin';
                        }
                        else if (options.proxy.proxyContract === 'OptimizedTransparentProxy') {
                            checkABIConflict = false;
                            proxyContract = network.zksync ? OptimizedTransparentUpgradeableProxy_json_2.default : OptimizedTransparentUpgradeableProxy_json_1.default;
                            viaAdminContract = 'DefaultProxyAdmin';
                            ...
                            proxyContract = network.zksync ? ERC1967Proxy_json_2.default : ERC1967Proxy_json_1.default;
...
Note that in this case, the contract deployment will not behave the same if deployed without proxy.
            ...
            if (typeof proxyAdminArtifactNameOrContract === 'string') {
                ...
                if (!proxyAdminContract) {
                    if (viaAdminContract === 'DefaultProxyAdmin') {
                        proxyAdminContract = network.zksync ? ProxyAdmin_json_2.default : ProxyAdmin_json_1.default;
                    }
                    else {
    ...
    async function _deployViaDiamondProxy(name, options) {
        ...
        let diamondArtifact = network.zksync ? Diamond_json_2.default : Diamond_json_1.default;
        ...
        if (options.defaultCutFacet === undefined || options.defaultCutFacet) {
            facetsSet.push({
                ...
                contract: network.zksync ? DiamondCutFacet_json_2.default : DiamondCutFacet_json_1.default,
                args: [],
                deterministic: true,
            });
        }
        if (options.defaultOwnershipFacet === undefined ||
            ...
            facetsSet.push({
                ...
                contract: network.zksync ? OwnershipFacet_json_2.default : OwnershipFacet_json_1.default,
                args: [],
                deterministic: true,
            });
        }
        facetsSet.push({
            ...
            contract: network.zksync ? DiamondLoupeFacet_json_2.default : DiamondLoupeFacet_json_1.default,
            args: [],
            deterministic: true,
        });
            ...
            if (!proxy) {
                ...
                if (initializationsArgIndex >= 0 || erc165InitArgIndex >= 0) {
                    const diamondERC165InitDeployment = await _deployOne('_DefaultDiamondERC165Init', {
                        from: options.from,
                        deterministicDeployment: true,
                        contract: network.zksync ? DiamondERC165Init_json_2.default : DiamondERC165Init_json_1.default,
                        autoMine: options.autoMine,
                        estimateGasExtra: options.estimateGasExtra,
                        estimatedGasLimit: options.estimatedGasLimit,
                        gasPrice: options.gasPrice,
